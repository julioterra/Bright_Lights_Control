...
public class User_Interface_Input extends Bright_Element implements Bright_Constants {
  ...
  public User_Interface_Input(PApplet _processing_app, Physical_Devices_Output _physical_output, Freq_Bands_Input _freq_bands_obj) {
      ...
      on_radio_button.setColorForeground(processing_app.color(120));
      on_radio_button.setColorActive(processing_app.color(255));
      on_radio_button.setColorLabel(processing_app.color(255));
      ...
      mode_radio_button.setColorForeground(processing_app.color(120));
      mode_radio_button.setColorActive(processing_app.color(255));
      mode_radio_button.setColorLabel(processing_app.color(255));
      ...
      scroll_radio_button.setColorForeground(processing_app.color(0, 0, 50));
      scroll_radio_button.setColorActive(processing_app.color(255));
      scroll_radio_button.setColorLabel(processing_app.color(255));
    ...
    void addToRadioButton(RadioButton theRadioButton, String theName, int theValue, int theColor, int theWidth) {
        ...
        toggle_select.captionLabel().setColorBackground(processing_app.color(theColor));
...
//        processing_app.println("EVENT RECEIVED IN USER INTERFACE");
        if(theEvent.isGroup()) {
//            processing_app.println("EVENT GROUP SENT TO CONTROLLER");
...
//            processing_app.println("EVENT GROUP SENT TO CONTROLLER");
    ...
    public void externalEvent(String id, float value) {
        if(id.contains("modeRadioButton") || id.contains("onOffRadioButton") || id.contains("scrollRadioButton")) {
            RadioButton temp_radio = (RadioButton) controlP5.getGroup(id);
            temp_radio.activate((int)value);
//            user_interface.controlP5.group(id).activate((int)value);
        }
        else {
            controlP5.controller(id).setValue(value);
        }
    }
